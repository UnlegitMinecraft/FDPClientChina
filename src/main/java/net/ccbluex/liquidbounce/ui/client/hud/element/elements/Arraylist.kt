...
class Arraylist(
    ...
    private val colorModeValue = ListValue("Text-Color", arrayOf("Custom", "Random", "Rainbow", "AnotherRainbow", "Slowly", "SkyRainbow", "Static"), "AnotherRainbow").displayable { colorDisplay.get() }
    ...
    private val noRenderModules = BoolValue("NoRenderModules", true).displayable { textDisplay.get() }
