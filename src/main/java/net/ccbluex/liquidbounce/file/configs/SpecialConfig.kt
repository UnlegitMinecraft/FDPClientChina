...
class SpecialConfig(file: File) : FileConfig(file) {
    ...
    override fun loadConfig(config: String) {
        ...
        FDPClientChina.commandManager.prefix = '.'
        ...
        if (json.has("prefix")) {
            FDPClientChina.commandManager.prefix = json.get("prefix").asCharacter
        }
    ...
    override fun saveConfig(): String {
        ...
        json.addProperty("prefix", FDPClientChina.commandManager.prefix)
