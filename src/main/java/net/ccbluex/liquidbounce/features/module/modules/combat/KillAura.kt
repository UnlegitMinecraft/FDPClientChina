...
object KillAura : Module() {
        ...
        override fun onDisable() {
            FDPClientChina.moduleManager[TargetStrafe::class.java]!!.doStrafe = false
            currentTarget = null
            hitable = false
            packetSent = false
        ...
        fun onUpdate(ignoredEvent: UpdateEvent) {
            ...
            FDPClientChina.moduleManager[TargetStrafe::class.java]!!.targetEntity = currentTarget ?: return

            FDPClientChina.moduleManager[StrafeFix::class.java]!!.applyForceStrafe(
        ...
        private fun updateTarget() {
            ...
            for (entity in inRangeDiscoveredTargets) {
                ...
                if (mc.thePlayer.getDistanceToEntityBox(entity) < discoverRangeValue.get()) {
                    ...
                    FDPClientChina.moduleManager[TargetStrafe::class.java]!!.targetEntity = currentTarget ?: return
                    FDPClientChina.moduleManager[TargetStrafe::class.java]!!.doStrafe =
                        FDPClientChina.moduleManager[TargetStrafe::class.java]!!.toggleStrafe()
                    return
                }
            }
        ...
        private val cancelRun: Boolean
            get() = mc.thePlayer.isSpectator || !isAlive(mc.thePlayer)
                    || (blinkCheck.get() && FDPClientChina.moduleManager[Blink::class.java]!!.state)
                    || FDPClientChina.moduleManager[FreeCam::class.java]!!.state
                    || (noScaffValue.get() && FDPClientChina.moduleManager[Scaffold::class.java]!!.state)
                    || (noFlyValue.get() && FDPClientChina.moduleManager[Fly::class.java]!!.state)
