...
class Scaffold : Module() {
    ...
    private val counterDisplayValue = BoolValue("Counter", true).displayable { renderOptions.get() }
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        FDPClientChina.moduleManager[StrafeFix::class.java]!!.applyForceStrafe(true, moveFixValue.get())
